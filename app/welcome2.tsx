  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#353540', padding: 50 }}>
      ...
      <View style={{ width: '100%', backgroundColor: '#45475A', padding: 15, borderRadius: 10, marginBottom: 15 }}>
        <Text style={{ color: 'white', fontSize: 16, textAlign: 'center' }}>"Remembers what user said earlier in the conversartion"</Text>
      </View>

      <View style={{ width: '100%', backgroundColor: '#45475A', padding: 15, borderRadius: 10, marginBottom: 15 }}>
        <Text style={{ color: 'white', fontSize: 16, textAlign: 'center' }}>"Allows user to provide follow-up corrections"</Text>
      </View>

      <View style={{ width: '100%', backgroundColor: '#45475A', padding: 15, borderRadius: 10, marginBottom: 30 }}>
        <Text style={{ color: 'white', fontSize: 16, textAlign: 'center' }}>"Trained to decline inappropriate"</Text>
      </View>
